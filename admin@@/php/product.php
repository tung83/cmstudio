...
function product_cate($db)
{
	...
	if(isset($_POST["addNew"])) {
        $insert = array(
                    ...
                    'active'=>$active,'meta_keyword'=>$meta_kw,'e_meta_keyword'=>$e_meta_kw,
...
function product($db){
	...
	if(isset($_POST["addNew"])) {
        $insert = array(
                    ...
                    'e_content'=>$e_content,'video'=>$video,'ind'=>$ind,
    ...
    $head_title=array('Tiêu đề','Hình ảnh','Giá bán','Giá thuê','Danh mục','Thứ tự','Hiển thị');
	$str.=$form->table_start($head_title);
