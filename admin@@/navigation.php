...
function ad_menu()
{
	$topNav=array(
					...
					array(3,"Quản lý dự án","news","pencil"),		
                    array(4,"Hợp tác","about","fire"),                 
                    array(8,'Hướng dẫn','manual','bell-o'),
                    array(9,'CMFilm','video','youtube'),
	...
	$subNav=array(
                    ...
                    array(2,'Sản phẩm','type=product'),  
                    array(3,'Danh mục dự án','type=news_cate'),
                    array(3,'Dự án','type=news'),
